  ...
  return (
    <main className="max-w-7xl mx-auto flex flex-col gap-y-2 my-2 min-h-[50vh]">
      ...
      <div className="box p-4 text-center text-xl flex flex-col gap-y-3">
        ...
        <h2 className="text-mainPurple text-3xl pt-10 pb-4">خرید از ما به 2 روش قابل انجام میباشد</h2>
        <p className="text-right">1. بازدید حضوری: شما میتوانید باهماهنگی قبلی تشریف بیارید و از نزدیک توله مدنظر خود را ببینید و در صورت تمایل اقدام به خرید نمایید.</p>
        <p className="text-right">2. خرید آنلاین: همچنین میتوانید با دیدن ویدئو ها توله مدنظر خود را انتخاب کرده و اقدام به خرید کنید و در سریع ترین زمان ممکن درب منزل تحویل بگیرید.</p>
